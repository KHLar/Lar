...
public LectureQ(int lecture_q_index, int lecture_q_writer_index, int lecture_q_lecture_index, String lecture_q_title,
		String lecture_q_content, int lecture_q_hits, Date lecture_q_upload_date, Date lecture_q_update_date,
		int lecture_q_is_deleted) {
	super();
...
public Date getLecture_q_update_date() {
	return lecture_q_update_date;
}
public void setLecture_q_update_date(Date lecture_q_update_date) {
	this.lecture_q_update_date = lecture_q_update_date;
}
...
public String toString() {
	return "LectureQ [lecture_q_index=" + lecture_q_index + ", lecture_q_writer_index=" + lecture_q_writer_index
			...
			+ ", lecture_q_upload_date=" + lecture_q_upload_date + ", lecture_q_update_date=" + lecture_q_update_date
			+ ", lecture_q_is_deleted=" + lecture_q_is_deleted + "]";
}
