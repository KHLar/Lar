...
public class LectureReview {
		...
		public LectureReview(int lecture_review_index, int lecture_review_lecture_index,
				int lecture_review_writer_index, String lecture_review_title, String lecture_review_content,
				int lecture_review_score, Date lecture_review_upload_date, Date lecture_review_update_date,
		...
		public String toString() {
			return "LectureReview [lecture_review_index=" + lecture_review_index + ", lecture_review_lecture_index="
					...
					+ lecture_review_update_date + ", lecture_is_deleted=" + lecture_is_deleted + "]";
		}
