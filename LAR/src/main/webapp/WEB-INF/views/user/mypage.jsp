						...
						<div class="col-md-9 col-xs-12 col-sm-8 col-lg-9">
							<div class="wrapprofile">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<input type="password" placeholder="비밀번호를 입력해주세요"
													id="pass_word"> <span style="float: right;">
													<button type="button"
														class="btn btn-primary btn pull-right"
														data-dismiss="modal">취소</button>
													<button type="button" onclick="InfoBtn();"
														class="btn btn-primary btn pull-right">확인</button>
												</span>
											</div>
										</div>
								...
								<button type="button" data-toggle="modal"
									data-target="#passwordCheck"
									class="btn btn-primary btn pull-right"
									style="margin-top: 18px;">정보수정</button>
							</div>
