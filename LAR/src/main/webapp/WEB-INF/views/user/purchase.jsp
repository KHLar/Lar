...
<div class="row">
	...
	<table class="table" style="border-bottom: 1px solid #ddd;">
		<tr>
			<td>신청자 명</td>
			<td><input type="text" class="form-control" name="" id="" style="width:300px;"/></td>
		</tr>
		<tr>
			<td>연락처</td>
			<td class="form-inline"><input type="text" class="form-control" name="" id="" style="width:50px;"/> - <input type="text" class="form-control" name="" id="" style="width:60px;"/> - <input type="text" class="form-control" name="" id="" style="width:60px;"/></td>
		</tr>
		<tr>
			<td>이메일</td>
			<td><input type="email" class="form-control" id="exampleInputEmail1" placeholder="이메일을 입력하세요" style="width:300px;"></td>
		</tr>
	</table>
