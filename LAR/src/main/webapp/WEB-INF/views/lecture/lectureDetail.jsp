		...
		<div class="col-md-10 col-sm-10">
			<div class="tabs lectureTab">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" id="lectureTab Tabs"><a id="atab"
						data-toggle="tab" data-target="#lectureList">강좌소개</a></li>
					<li role="presentation" id="qaTab Tabs"><a id="atab"
						data-toggle="tab" data-target="#QnA">질의응답</a></li>
				</ul>
			</div>
							...
							<c:forEach items="${qlist}" var="q">
								<tbody>
									<tr>
										...
										<td><a
											href="/lar/lecture/QnA/detail/${q.LECTURE_Q_INDEX}">${ q.LECTURE_Q_TITLE }</a></td>
