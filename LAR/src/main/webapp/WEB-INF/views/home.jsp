...
<!-- Header -->
        ...
        <div class="container main-carousel" style="width: 100%">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li data-target="#carousel-example-generic" data-slide-to="0" class="active" style="border: 1px solid gray"></li>
                    <li data-target="#carousel-example-generic" data-slide-to="1" style="border: 1px solid gray"></li>
                    <li data-target="#carousel-example-generic" data-slide-to="2" style="border: 1px solid gray"></li>
                </ol>
    ...
    <div class="wrapper" style="margin-top: 50px; margin-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-10" style="border-right: solid 1px lightgray; padding-right: 5%">
                    <div class="row">
