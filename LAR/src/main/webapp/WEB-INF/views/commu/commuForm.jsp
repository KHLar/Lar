...
<body>
	...
	<div class="container col-lg-10 col-md-10 col-sm-10">
		...
		<br> <br>
		<form name="commuFrm"
			action="${pageContext.request.contextPath}/commu/commuFormEnd"
			...
			<div class="col-lg-10 col-md-10 col-sm-10"
				...
				<div class="form-group">
					<input type="text" class="form-control" id="commu_Title"
						name="commu_Title" placeholder="title">
				</div>
				<div class="form-group">
					<div class="custom-file">
						<input style="margin-top: 25px;" type="file"
							class="custom-file-input" name="upFile" id="upFile"multiple ${req}>
					</div>
				</div>
				<br>
				<div class="bootstrap-tagsinput form-group">
					<div class="form-control tags" id="tags">
						<input type="text" class="labelinput"> <input
							type="hidden" value="" name="result">
					</div>
				</div>
				<br>
				<div class="form-group">
			...
			<input type="hidden" id="commu_Category_Index"
				name="commu_Category_Index" value="${commu_Category_Index}" /> <input
				type="hidden" id="commu_Content" name="commu_Content"> <input
				type="hidden" id="commu_Writer_Index" name="commu_Writer_Index"
