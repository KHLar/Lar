...
public class UserController {
	...
	public String findPassword(@RequestParam(value="user_id", required=true) String user_id,
	...
	public String passwordAuthCompare(@RequestParam(value="user_id", required=true) String id_for_forgot_input,
								...
								@SessionAttribute("passwordAuth") String passwordAuth,
								@SessionAttribute("user_id_s") String user_id_s,
	...
	public String unlockSendmail(@RequestParam(value="user_id", required=true) String user_id,
								HttpSession session, Model model) {
	...
	public String unlockCompare(@RequestParam(value="user_id", required=true) String user_id,
								...
								@SessionAttribute("unlockAuth") String unlockAuth,
								@SessionAttribute("user_id_s") String user_id_s,
								SessionStatus sessionStatus, Model model) {
	...
	public String passwordModify(@RequestParam(value="user_id", required=true) String user_id,
								@RequestParam(value="newPassword", required=true) String newPassword, Model model, SessionStatus sessionStatus) {
