...
public BoardLectureAttachment(int lecture_attach_index, int lecture_attach_board_index,
		String lecture_attach_originfilename, String lecture_attach_renamedfilename, Date lecture_attach_uploaddate) {
	super();
...
public int hashCode() {
	...
	result = prime * result + ((lecture_attach_originfilename == null) ? 0 : lecture_attach_originfilename.hashCode());
	result = prime * result
