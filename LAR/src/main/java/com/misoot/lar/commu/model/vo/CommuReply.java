...
public class CommuReply {
	...
	private Date commu_Reply_Upload_Date;
	private Date commu_Reply_Update_Date;
	...
	public CommuReply(int commu_Reply_Index, int commu_Reply_Commu_Index, int commu_Reply_Parent_Index,
			...
			Date commu_Reply_Upload_Date, Date commu_Reply_Update_Date, int commu_Reply_Depth_Index,
	...
	public Date getCommu_Reply_Upload_Date() {
		return commu_Reply_Upload_Date;
	}
	public void setCommu_Reply_Upload_Date(Date commu_Reply_Upload_Date) {
		this.commu_Reply_Upload_Date = commu_Reply_Upload_Date;
	}
	public Date getCommu_Reply_Update_Date() {
		return commu_Reply_Update_Date;
	}
	public void setCommu_Reply_Update_Date(Date commu_Reply_Update_Date) {
		this.commu_Reply_Update_Date = commu_Reply_Update_Date;
	}
